...
export interface AnalyticsSkeletonProps {
  /** Localized loading label (e.g. `Analytics.loading`). */
...
/**
 * Analytics loading skeleton — mirrors the 2×2 stat-card grid plus a wide
 ...
 */
export function AnalyticsSkeleton({t, label}: AnalyticsSkeletonProps) {
  return (
