...
export const PROTOTYPE_FLOW_SEGMENTS: readonly PrototypeFlowSegment[] = [
  ...
  {state: 'NEXT_EXERCISE', durationMs: 2_000},
] as const;

export const REST_START_MS = 34_000;
export const REST_PREVIEW_START_MS = 59_000;
export const COUNTDOWN_START_MS = 64_000;
export const FLOW_FINAL_WORK_NORMAL_MS = 69_000;
