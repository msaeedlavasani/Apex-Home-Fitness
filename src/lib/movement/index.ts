 ...
 * model; MG-07 — localization + media architecture).
 *
 ...
 * for user-facing movement content, and the self-hosted media manifest
 * format (content-hash integrity + no-third-party-CDN rules). This domain
