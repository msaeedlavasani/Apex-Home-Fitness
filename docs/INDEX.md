...
| AL-04 Adaptive Training Graph decision gate (PREPARED / AWAITING OWNER DECISION 2026-09-03; smallest-safe-v1 decision model over the AL-03 AdaptationInput boundary — L0 safety gates → L1 session frame → L2 per-movement KEEP/PROGRESS/REGRESS/SUBSTITUTE/EXCLUDE → L3 sets deltas; pure + deterministic, zero inference inside AL-04, fail-closed insufficient-data posture, fixed-EN-template explainability; sequencing + catalog exercise selection deferred; **4 Owner decisions D1–D4 — does NOT authorize AL-04**) | [`architecture/AL-04-DECISION-GATE.md`](architecture/AL-04-DECISION-GATE.md) |
