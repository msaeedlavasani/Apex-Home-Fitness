...
| معماری (S-03 — GATE B هسته‌ی خالص Session) | [`architecture/S03-SESSION-CORE-GATE-B.md`](architecture/S03-SESSION-CORE-GATE-B.md) | PROPOSED — OWNER APPROVAL REQUIRED (GB-01..GB-10 PENDING) |
