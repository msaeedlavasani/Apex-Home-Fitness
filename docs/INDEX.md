...
| S02-E Exercise Identity Backfill preflight + capability-gap record (capability now provided; apply NOT executed) | [`architecture/S02E-BACKFILL-PREFLIGHT.md`](architecture/S02E-BACKFILL-PREFLIGHT.md) |
