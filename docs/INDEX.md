...
| Pose/form feasibility spike (CP-03 — FINDINGS DELIVERED / AWAITING OWNER REVIEW 2026-09-03; RESEARCH_ONLY — no product code; published-evidence evaluation: MoveNet TF.js best Android-browser FPS (34 on Pixel 5) vs BlazePose ~11–12; ML Kit/Apple Vision native-only (contradicts web-first posture); JMIR 2026 camera-placement dominance (61% mean detection across configs; 85–95% best); Pūioio 98.89% on-device rep counting; derived battery budget; v1 HIGH-coverage movement scope over the canonical catalog; recommendation = Approach A MoveNet in-browser + guided capture + benchmark measurement gate) | [`architecture/CP-03-POSE-FEASIBILITY.md`](architecture/CP-03-POSE-FEASIBILITY.md) |
