...
| Next authorized task | `NONE` (ADMIN-THEME-SWITCH-01 DELIVERED/CLOSED 2026-09-01; next candidates: new owner-assigned work) |
| Pending owner review | Next-batch authorization; ADMIN-IMPERSONATION-01 deferred/not authorized; MOBILE-READINESS guardrails + typography contract RATIFIED (ADR-0005 / DESIGN_SYSTEM.md §4.1) |
