...
```json
{
  ...
  "items": [
    ...
    {"id":"WORKOUT-V2-PERSISTED-ENTRY-IDENTITY-CORRECTION","status":"PLANNED","frozen":false,"readinessRule":"DAG_DERIVED","admissionRequired":true,"admissionPath":"docs/admissions/WORKOUT-V2-PERSISTED-ENTRY-IDENTITY-CORRECTION.admission.json","taskProfile":"DB_CHANGE","parallelSafety":"SERIAL_ONLY","ownerVisualAcceptanceRequired":false,"verification":"PENDING","result":"Governed remediation for the evidenced ProgramExercise identity defect: distinct prescribed Entries must be independently persistable while referencing one canonical Exercise. No product decision is pending; migration/backfill and canonical QA persistence proof remain required."},
