...
```json
{
  ...
  "items": [
    ...
    {"id":"WORKOUT-V2-CORRECTION-BETA-DEPLOYMENT-CHECKPOINT","status":"BLOCKED","frozen":false,"readinessRule":"DAG_DERIVED","admissionRequired":false,"ownerVisualAcceptanceRequired":false,"checkpointId":"WORKOUT-V2-CORRECTION-BETA-DEPLOYMENT-01","checkpointEvidencePath":"docs/checkpoints/WORKOUT-V2-CORRECTION-BETA-DEPLOYMENT-01.json","verification":"BLOCKED_CANONICAL_SOURCE_MISMATCH","supersededBy":"WORKOUT-V2-EXECUTION-STRATEGY-COMPLETENESS-RECOVERY","result":"Gateway v5 rejected exact candidate ce1da7b5720c26e44c6ceaa741db72bf190caf13 because it is no longer the canonical open branch/PR head; no Beta mutation occurred"},
