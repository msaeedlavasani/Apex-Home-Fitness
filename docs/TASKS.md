...
| State | `AUTHORIZED — complete-flow checkpoint reconciliation required`; authoritative GitHub CI failed and RUN-5 remains blocked |
...
| Next selectable work | Repository-derived checkpoint reconciliation; `RUN-5-OWNER-ACCEPTANCE` remains blocked until authoritative CI PASS |
