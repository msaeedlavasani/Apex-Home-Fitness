...
```json
{
  ...
  "items": [
    ...
    {"id":"WORKOUT-V2-CANONICAL-BETA-DEPLOYMENT-CHECKPOINT","status":"PLANNED","frozen":false,"readinessRule":"DAG_DERIVED","ownerVisualAcceptanceRequired":false,"checkpointId":"WORKOUT-V2-CANONICAL-BETA-DEPLOYMENT-01","checkpointEvidencePath":"docs/checkpoints/WORKOUT-V2-CANONICAL-BETA-DEPLOYMENT-01.json","verification":"PENDING","result":"Historical failed-closed QA repair remains preserved. This checkpoint now requires WORKOUT-V2-PERSISTED-ENTRY-IDENTITY-CORRECTION plus governed post-migration QA persistence verification before PASS; Production remains untouched."},
