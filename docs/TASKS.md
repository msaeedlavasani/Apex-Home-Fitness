...
| State | `AUTHORIZED — real product integration and Beta path authorization recorded`; the derived Beta deployment capability is READY_DERIVED for the governed `beta.apexhomefit.ir` path; RUN-5 remains downstream |
...
| Next selectable work | `BETA-DEPLOYMENT-CAPABILITY` — READY_DERIVED after the Owner authorized establishment of the governed Beta target/path |
...
```json
{
  ...
  "items": [
    ...
    {"id":"BETA-DEPLOYMENT-CAPABILITY","status":"PLANNED","frozen":false,"readinessRule":"DAG_DERIVED","admissionRequired":true,"admissionPath":"docs/admissions/BETA-DEPLOYMENT-CAPABILITY.admission.json","taskProfile":"RELEASE","parallelSafety":"SERIAL_ONLY","ownerVisualAcceptanceRequired":false,"verification":"PENDING","result":"Owner authorized establishment of the governed Beta path at beta.apexhomefit.ir using the existing constrained gateway and isolated Beta resources"},
    {"id":"BETA-DEPLOYMENT-CHECKPOINT","status":"PLANNED","frozen":false,"readinessRule":"DAG_DERIVED","admissionRequired":false,"ownerVisualAcceptanceRequired":false,"checkpointId":"WORKOUT-V2-BETA-DEPLOYMENT-01","checkpointEvidencePath":"docs/checkpoints/WORKOUT-V2-BETA-DEPLOYMENT-01.json","verification":"PENDING","result":"Blocked until the governed Beta deployment capability is established and executed"},
