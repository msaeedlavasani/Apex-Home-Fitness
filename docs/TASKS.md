...
```json
{
  ...
  "items": [
    ...
    {"id":"WORKOUT-V2-CANONICAL-BETA-DEPLOYMENT-CHECKPOINT","status":"BLOCKED","frozen":false,"readinessRule":"DAG_DERIVED","ownerVisualAcceptanceRequired":false,"checkpointId":"WORKOUT-V2-CANONICAL-BETA-DEPLOYMENT-01","checkpointEvidencePath":"docs/checkpoints/WORKOUT-V2-CANONICAL-BETA-DEPLOYMENT-01.json","verification":"BLOCKED","result":"Exact post-recovery Beta source 8818e81dbe025a7058db412299a4d25ea51eda31 deployed and rollback/storage hygiene passed; governed QA Program repair failed closed because ProgramExercise @@id([programId, exerciseId]) cannot represent two distinct prescribed entries referencing one canonical Bodyweight Squat. A separately governed persistence/schema correction is required before this checkpoint can PASS."},
