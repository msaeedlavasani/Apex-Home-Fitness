...
```json
{
  ...
  "items": [
    ...
    {"id":"WORKOUT-V2-CORRECTION-BETA-DEPLOYMENT-CHECKPOINT","status":"PLANNED","frozen":false,"readinessRule":"DAG_DERIVED","admissionRequired":false,"ownerVisualAcceptanceRequired":false,"checkpointId":"WORKOUT-V2-CORRECTION-BETA-DEPLOYMENT-01","checkpointEvidencePath":"docs/checkpoints/WORKOUT-V2-CORRECTION-BETA-DEPLOYMENT-01.json","verification":"PENDING_POST_RECOVERY_SOURCE_RECONCILIATION","supersededBy":"WORKOUT-V2-EXECUTION-STRATEGY-COMPLETENESS-RECOVERY","result":"Historical ce1da7b5720c26e44c6ceaa741db72bf190caf13 deployment remains CURRENT_DEPLOYED_BETA/HISTORICAL_PRE_RECOVERY_CANDIDATE; select only the exact post-recovery canonical branch/PR head through gateway v5"},
