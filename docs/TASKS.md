...
| Next authorized task | CP-03 harness RETEST (Owner/human — macOS Chrome/Arc + Safari sanity per `scripts/pose-measurement/README.md` §3.1/§6, after BOTH 2026-09-04 repairs — smoke now 26/26 incl. pose-bearing check); then measurement-gate EXECUTION (physical devices) → findings review → product implementation. TS-03 READY but PROD_SENSITIVE (Production deletion acceptance); TS-05 needs TS-02 (HUMAN_GATE legal); TS-02 HUMAN_GATE; SU-01 NOT_YET |
