...
| State | `AUTHORIZED — complete-flow machine checkpoint PASS`; authoritative branch and PR GitHub CI passed; RUN-5 remains the downstream Human Gate |
...
| Next selectable work | `WP-15` and its derived downstream integration path; `RUN-5-OWNER-ACCEPTANCE` is re-blocked until the new product checkpoint and Beta authority gate are satisfied |
...
```json
{
  ...
  "items": [
    ...
    {"id":"WP-15","status":"PLANNED","frozen":false,"readinessRule":"DAG_DERIVED","admissionRequired":true,"admissionPath":"docs/admissions/WP-15.admission.json","taskProfile":"CODE_NO_DEPLOY","parallelSafety":"SERIAL_ONLY","ownerVisualAcceptanceRequired":false,"verification":"NOT_YET","result":"Normal authenticated product entry and Workout V2 promotion not yet executed"},
    {"id":"WP-16","status":"PLANNED","frozen":false,"readinessRule":"DAG_DERIVED","admissionRequired":true,"admissionPath":"docs/admissions/WP-16.admission.json","taskProfile":"CODE_NO_DEPLOY","parallelSafety":"SERIAL_ONLY","ownerVisualAcceptanceRequired":false,"verification":"NOT_YET","result":"QA Program domain-path data and verification not yet executed"},
    {"id":"PRODUCT-INTEGRATION-CHECKPOINT","status":"PLANNED","frozen":false,"readinessRule":"DAG_DERIVED","admissionRequired":false,"ownerVisualAcceptanceRequired":false,"checkpointId":"WORKOUT-V2-REAL-PRODUCT-INTEGRATION-01","checkpointEvidencePath":"docs/checkpoints/WORKOUT-V2-REAL-PRODUCT-INTEGRATION-01.json","verification":"PENDING","result":"Blocked until WP-15 and WP-16 close out"},
    {"id":"BETA-DEPLOYMENT-AUTHORIZATION","status":"HUMAN_GATE","frozen":false,"readinessRule":"EXPLICIT","autonomousEligibility":"HUMAN_GATE","admissionRequired":false,"ownerDecisionRequired":true,"ownerVisualAcceptanceRequired":false,"verification":"NOT_YET","result":"Repository currently has no canonical Beta deployment authority"},
