...
| Next authorized task | `NONE` (POST-S04-PRIORITY-01 re-ranked the remaining architecture backlog: S-06 → S-05 (GATE C) → S02-E; S-06+S-05 batchable, S02-E alone; awaiting owner promotion — see [`architecture/POST-S04-PRIORITY-01.md`](architecture/POST-S04-PRIORITY-01.md)) |
| Pending owner review | Promote next architecture item (S-06 decision-only, S-05 GATE C, or S02-E backfill); authorize TD-01/TD-02 spec reconciliation ([`TEST-DEBT.md`](TEST-DEBT.md)); ADMIN-IMPERSONATION-01 deferred/not authorized; MOBILE-READINESS guardrails + typography contract RATIFIED (ADR-0005 / DESIGN_SYSTEM.md §4.1) |
...
| S02-E and S-05..S-06 | **RE-RANKED 2026-09-01 (POST-S04-PRIORITY-01)** — S-06 (decision-only, no deps) first; S-05 (Snapshot Versioning; depends on CLOSED S-04; GATE C) second; S02-E (Exercise Identity backfill; DB-touching; own lifecycle) last; S-06+S-05 batchable, S02-E NOT batchable. **S-06 DECIDED + S-05 EXECUTED (GATE C APPROVED) in STABILIZATION BATCH S06+S05 (2026-09-01); S02-E remains the next isolated Production-DB lifecycle** | [`architecture/POST-S04-PRIORITY-01.md`](architecture/POST-S04-PRIORITY-01.md), [`architecture/S06-CATALOG-ROLE.md`](architecture/S06-CATALOG-ROLE.md), [`architecture/ARCHITECTURE-STABILIZATION-PLAN.md`](architecture/ARCHITECTURE-STABILIZATION-PLAN.md) |
| `rtl-layout.spec.ts` stale expectations (TD-01 nav-order five-item `APP_NAV`; TD-02 quiz radiogroup scope) | **CONFIRMED TEST DEBT 2026-09-01** — reproduced identically on clean `main`; not app regressions; not in CI's e2e gate; **FIXED in STABILIZATION BATCH S06+S05 (2026-09-01)** pending full-suite E2E verification | [`TEST-DEBT.md`](TEST-DEBT.md) |
