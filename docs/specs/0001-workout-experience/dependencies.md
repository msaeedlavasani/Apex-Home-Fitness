...
```json
{
  ...
  "nodes": [
    ...
    {"id":"INTEGRATION-CHECKPOINT-WORKOUT-V2-COMPLETE-FLOW","dependsOn":["RUN-4-PROGRAM-COMPOSITION"],"kind":"INTEGRATION","checkpointId":"WORKOUT-V2-COMPLETE-FLOW-INTEGRATION-01","checkpointEvidencePath":"docs/checkpoints/WORKOUT-V2-COMPLETE-FLOW-INTEGRATION-01.json","status":"PLANNED","frozen":false,"verification":"PENDING"},
