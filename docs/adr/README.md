...
| [`0016-adaptation-input-pipeline.md`](./0016-adaptation-input-pipeline.md) | ACCEPTED (2026-09-03) | Adaptation input pipeline = canonical decision-layer input schema (AdaptationInput) + pure deterministic projection of (profile, movement knowledge, workout history); attributed inference, evidence refs, fail-closed missing-profile/empty-history edges; authorizes no decision-making — AL-04 remains NOT_YET + gated (AL-03) |
