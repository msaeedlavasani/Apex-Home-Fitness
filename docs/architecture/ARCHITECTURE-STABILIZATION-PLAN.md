...
- **S03-A COMPLETE (2026-08-27)**: parity baseline frozen BEFORE extraction.
  ...
  `useWorkoutEngine` unchanged. S03-B (pure core) implemented in parallel and not runtime-active; S03-C through S03-F complete: runtime delegation, timer boundary, effect boundary, and final closure verified; S03 is closed. S04+ not started.
