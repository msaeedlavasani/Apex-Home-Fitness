...
- **S03-A COMPLETE (2026-08-27)**: parity baseline frozen BEFORE extraction.
  ...
  `useWorkoutEngine` unchanged. S03-B (pure core) implemented in parallel and not runtime-active; S03-C complete: hook delegates session transitions to pure core. S03-D complete: timer/accumulator boundary verified and hardened. S03-E complete: effect boundary verified/hardened; S03-F not started.
